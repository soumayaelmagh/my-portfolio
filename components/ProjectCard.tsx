    ...
    <motion.article whileHover={{ scale: 1.02 }} transition={{ type: "spring", stiffness: 220 }}
      ...
      <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col items-center justify-center text-center px-4">
        ...
        <div className="flex gap-3">
          ...
          {links?.github && (
            <a
              className="px-4 py-2 bg-gray-700 text-white rounded-full font-medium hover:bg-gray-600 transition"
              href={links.github}
              target="_blank"
              rel="noreferrer noopener"
            >
          ...
          {links?.caseStudy && (
            <a
              className="px-4 py-2 border border-gray-400 text-gray-100 rounded-full hover:bg-gray-700/50 transition"
